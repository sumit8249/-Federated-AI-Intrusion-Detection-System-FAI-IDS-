"""
Federated Client 1: Apex Bank Network
Spec Reference: Section 4 (Client Organizations - Bank) & Section 17
"""
...
def start_client(server_address: str = "127.0.0.1:8080"):
    client_id = "client_001_bank"
    org_name = "Apex Bank Network"
    org_type = "Banking"

    print(f"[{org_name}] Initializing Bank Intrusion Detection Node...")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Start Bank Federated Client")
